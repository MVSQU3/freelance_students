...
import ManageCompetences from "./pages/StudentPages/ManageCompetences.jsx";
// END COMPANY ROUTES
function App() {
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/student/add/competences"
          element={authUser ? <ManageCompetences /> : <Login />}
        />
        <Route
          path="/company/stage/:id"
